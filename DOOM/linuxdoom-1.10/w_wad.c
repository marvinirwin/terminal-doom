...
void W_AddFile(char *filename) {
    ...
    // TODO figure out how to do signed int to unsigned in.  I don't think it's this simple, is it?
...
//
// MARVIN
// I've decided this can fail because of my goofy memory issues so it returns into now
int
W_ReadLump
        (int lump,
         void *dest) {
...
/*    //printf("Reading lump %s\n", l->name);*/
    ...
    memcpy(dest, (void*)&entireWad[pos], l->size);
