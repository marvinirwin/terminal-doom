...
void P_RespawnSpecials (void)
{
    ...
    mo = P_SpawnMobj (static_cast<fixed_t>(x),static_cast<fixed_t>(y),static_cast<fixed_t>(z), (mobjtype_t)i);
...
void P_SpawnMapThing (mapthing_t* mthing)
{
    ...
    mobj = P_SpawnMobj ((fixed_t)x,(fixed_t)y,(fixed_t)z, (mobjtype_t)i);
